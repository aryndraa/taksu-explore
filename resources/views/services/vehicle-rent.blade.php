...
@section ('title', 'Vehicle Rental - Taksu Explore')

{{-- SEO --}}
@section ('meta_description',
    'Rent a private car or van with Taksu Explore. Enjoy flexible schedules, professional
...
@section ('meta_keywords',
    ...
    vehicle hire, Taksu Explore')
@section ('og_title', 'Bali Car & Vehicle Rental | Taksu Explore')
